...
{REDUND_OK} FUNCTION_BLOCK MTBasicsDT1 (*First-order derivative action element.*) (* $GROUP=mapp Control,$CAT=Control Tools,$GROUPICON=Icon_mapp.png,$CATICON=Icon_mappControlTools.png *)
	VAR_INPUT
...
{REDUND_OK} FUNCTION_BLOCK MTBasicsDT2 (*Second-order derivative action element.*) (* $GROUP=mapp Control,$CAT=Control Tools,$GROUPICON=Icon_mapp.png,$CATICON=Icon_mappControlTools.png *)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*)
		Gain : REAL; (*Gain factor.*)
...
{REDUND_OK} FUNCTION_BLOCK MTBasicsIntegrator (*Integrator.*) (* $GROUP=mapp Control,$CAT=Control Tools,$GROUPICON=Icon_mapp.png,$CATICON=Icon_mappControlTools.png *)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*)
...
{REDUND_OK} FUNCTION_BLOCK MTBasicsLevelController (*Level controller.*) (* $GROUP=mapp Control,$CAT=Control Tools,$GROUPICON=Icon_mapp.png,$CATICON=Icon_mappControlTools.png *)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*)
...
{REDUND_OK} FUNCTION_BLOCK MTBasicsLimiter (*Limiter.*) (* $GROUP=mapp Control,$CAT=Control Tools,$GROUPICON=Icon_mapp.png,$CATICON=Icon_mappControlTools.png *)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*)
...
{REDUND_OK} FUNCTION_BLOCK MTBasicsOscillationTuning (*Oscillation tuning for PID.*) (* $GROUP=mapp Control,$CAT=Control Tools,$GROUPICON=Icon_mapp.png,$CATICON=Icon_mappControlTools.png *)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*)
...
{REDUND_OK} FUNCTION_BLOCK MTBasicsPFM (*Pulse frequency modulator.*) (* $GROUP=mapp Control,$CAT=Control Tools,$GROUPICON=Icon_mapp.png,$CATICON=Icon_mappControlTools.png *)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*)
...
{REDUND_OK} FUNCTION_BLOCK MTBasicsPID (*PID controller.*) (* $GROUP=mapp Control,$CAT=Control Tools,$GROUPICON=Icon_mapp.png,$CATICON=Icon_mappControlTools.png *)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*)
		PIDParameters : MTPIDParametersType; (*PID parameters.*)
		MinOut : REAL;
...
{REDUND_OK} FUNCTION_BLOCK MTBasicsPT1 (*First-order delay element.*) (* $GROUP=mapp Control,$CAT=Control Tools,$GROUPICON=Icon_mapp.png,$CATICON=Icon_mappControlTools.png *)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*)
		Gain : REAL; (*Gain factor.*)
		TimeConstant : REAL; (*Time constant. Unit: [s]. Valid value range: TimeConstant >= 0.*)
...
{REDUND_OK} FUNCTION_BLOCK MTBasicsPT2 (*Second-order delay element.*) (* $GROUP=mapp Control,$CAT=Control Tools,$GROUPICON=Icon_mapp.png,$CATICON=Icon_mappControlTools.png *)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*)
		Gain : REAL; (*Gain.*)
		TimeConstant1 : REAL; (*Time constant. Unit: [s]. Valid value range: TimeConstant1 >= 0.*)
...
{REDUND_OK} FUNCTION_BLOCK MTBasicsPWM (*Pulse width modulator.*) (* $GROUP=mapp Control,$CAT=Control Tools,$GROUPICON=Icon_mapp.png,$CATICON=Icon_mappControlTools.png *)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*)
...
{REDUND_CONTEXT} FUNCTION_BLOCK MTBasicsPWMSchedule (*Multiple pulse width modulator.*) (* $GROUP=mapp Control,$CAT=Control Tools,$GROUPICON=Icon_mapp.png,$CATICON=Icon_mappControlTools.png *)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*)
...
{REDUND_OK} FUNCTION_BLOCK MTBasicsStepTuning (*Step tuning for PID.*) (* $GROUP=mapp Control,$CAT=Control Tools,$GROUPICON=Icon_mapp.png,$CATICON=Icon_mappControlTools.png *)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*)
...
{REDUND_CONTEXT} FUNCTION_BLOCK MTBasicsTimeDelay (*Delay element.*) (* $GROUP=mapp Control,$CAT=Control Tools,$GROUPICON=Icon_mapp.png,$CATICON=Icon_mappControlTools.png *)
	VAR_INPUT
		Enable : BOOL; (*Enables/Disables the function block.*)
