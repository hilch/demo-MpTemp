...
FUNCTION_BLOCK MpTempController (*mapp component to tune and control temperature systems.*) (* $GROUP=mapp Control,$CAT=Temperature,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpTemp.png *)
	VAR_INPUT
...
FUNCTION_BLOCK MpTempControllerConfig (*mapp component to configure a MpTempController FB.*) (* $GROUP=mapp Control,$CAT=Temperature,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpTemp.png *)
	VAR_INPUT
...
FUNCTION_BLOCK MpTempGroup (*mapp component to control all linked components of a temperature group.*) (* $GROUP=mapp Control,$CAT=Temperature,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpTemp.png *)
	VAR_INPUT
		MpLink : REFERENCE TO MpComIdentType; (*Connection to mapp.*) (* *) (*#PAR#;*)
		Enable : BOOL; (*Enables/Disables the function block.*) (* *) (*#PAR#;*)
		ErrorReset : BOOL; (*Resets  function block errors.*) (* *) (*#PAR#;*)
...
FUNCTION_BLOCK MpTempGroupConfig (*mapp component to configure a MpTempGroup FB.*) (* $GROUP=mapp Control,$CAT=Temperature,$GROUPICON=Icon_mapp.png,$CATICON=Icon_MpTemp.png *)
	VAR_INPUT
		MpLink : REFERENCE TO MpComIdentType; (*Incoming communication handle (mapp standard interface).*) (* *) (*#PAR#;*)
		Enable : BOOL; (*Enables/Disables the function block (mapp standard interface).*) (* *) (*#PAR#;*)
		ErrorReset : BOOL; (*Resets all function block errors (mapp standard interface).*) (* *) (*#PAR#;*)
